                ...
                $.each(response.data, function(index, product) {
                    ...
                    var row = '<tr>' +
                        ...
                        <td class="p-4 space-x-2 whitespace-nowrap">
                            <button type="button" id="update-product" data-id="${product.id}" class="update-product inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-wc-red-400 rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                                Ubah
                            </button>
                            <button type="button" id="deleteProductButton" data-id="${product.id}" class="delete-product inline-flex items-center px-3 py-2 text-sm font-medium text-center text-red-600 border border-red-800 bg-white rounded-lg hover:text-white hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
    ...
    $(document).off('change').on('change', '.checkbox-product', function(){
        ...
        if ($('.checkbox-product:checked').length > 0){
            ...
            let $content = $(`<div class="w-full flex items-center gap-4">
                ...
                <button type="button" id="nonactive-products" class="px-3 py-2 text-xs font-medium text-gray-700 focus:outline-none bg-none rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-wc-red-400 focus:z-10 focus:ring-4 focus:ring-gray-100">Nonaktifkan produk</button>
                <div class="">
