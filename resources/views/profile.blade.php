        ...
        <div class="col-span-12 md:col-span-8">
            ...
            <div class="" id="default-tab-content">
                ...
                <div class="rounded-b-xl bg-white p-6" id="address" role="tabpanel" aria-labelledby="dashboard-tab">
                    ...
                    <div class="p-6 rounded-lg bg-white flex justify-between items-center shadow-lg mb-4">
                        <div class="">
                            ...
                            <p class="text-sm mb-2">{{ $alamat->lengkap }}</p>
                        </div>
                        <div class="flex flex-col gap-2">
                            <button type="button" class="px-4 py-2 text-xs font-medium text-center text-white bg-wc-red-400 rounded-lg hover:bg-wc-red-300 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-wc-red-400 dark:focus:ring-blue-800">Pilih</button>
                            <button type="button" class="px-4 py-2 text-xs font-medium text-center  text-wc-red-400 rounded-lg border border-wc-red-400  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-wc-red-400 dark:focus:ring-blue-800">Ubah</button>
                        </div>
                    </div>
                    @endforeach
                </div>
