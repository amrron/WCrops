...
@section('content')
    <h5 class="text-2xl font-semibold mb-4">Wishlist</h5>
    <div class="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
        @foreach ($wishlists as $wishlist)
        <div class="w-full max-w-sm rounded-xl border shadow-md product-card">
            <a href="#" class="">
                <div class="p-4 relative">
                    <img class="rounded-lg w-full aspect-square object-cover mb-4" src="/storage/{{ $wishlist->produk->gambar }}" alt="product image" />
                    ...
                    <div class="mt-4 flex gap-2">
                        <button type="button" class="remove-from-wishlist text-gray-900 border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm p-2" data-id="{{ $wishlist->id }}">
