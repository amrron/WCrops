          ...
          <div class="overflow-hidden shadow p-6">
            @foreach ($transaksis as $transaksi)                
              <div class="w-full bg-white shadow mb-6 rounded-xl">
                    ...
                    <div class="grid grid-cols-12 p-4 border-x">
                    ...
                    <div class="w-full p-3 border border-t-gray-200 flex justify-end gap-4 rounded-b-xl">
                        <button type="button" class="px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Terima Pesanan</button>
                    </div>
              </div>
            @endforeach
          </div>
