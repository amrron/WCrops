...
<form class="max-w-sm mx-auto shadow-md p-4 rounded-xl" action="/register" method="post">
  @csrf
    <div class="mb-5">
    ...
    <div class="mb-5">
      ...
      <input type="password" id="repeat-password" name="password_confirmation" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " required />
    </div>
