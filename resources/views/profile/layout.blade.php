...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-0 md:mt-6 relative">
        <div class="col-span-12 md:col-span-3 {{ request()->routeIs('profile.ubah') ? "hidden md:flex" : "" }}">
            <div class="w-full rounded-none md:rounded-xl shadow-lg flex flex-col border">
                ...
                <div class="w-full p-6">
                    <div class="w-full flex flex-row justify-between md:flex-col gap-4 list-none text-sm md:text-normal">
                        <a href="/profile" class="flex gap-4 items-center font-semibold p-2 rounded-lg {{ request()->routeIs('profile.akun') || request()->routeIs('profile.ubah') ?  "text-white bg-wc-red-400" : "bg-white text-wc-red-400" }} hover:text-white hover:bg-wc-red-400">
                        ...
                        <a href="/profile/ulasan" class="flex gap-4 items-center font-semibold p-2 rounded-lg {{ request()->routeIs('profile.ulasan') ?  "text-white bg-wc-red-400" : "bg-white text-wc-red-400" }} hover:text-white hover:bg-wc-red-400">
                            <svg class="hidden md:block w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <a href="/profile/password" class="flex gap-4 items-center font-semibold p-2 rounded-lg {{ request()->routeIs('profile.password') ?  "text-white bg-wc-red-400" : "bg-white text-wc-red-400" }} hover:text-white hover:bg-wc-red-400">
                            <svg class="hidden md:block w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
