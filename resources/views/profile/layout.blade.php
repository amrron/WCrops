            ...
            <div class="w-full rounded-none md:rounded-xl shadow-lg flex flex-col border">
                ...
                <div class="w-full p-6">
                    <div class="w-full flex flex-row justify-between md:flex-col gap-4 list-none text-sm md:text-normal">
                        <a href="/profile" class="flex gap-4 items-center font-semibold p-2 rounded-lg {{ request()->routeIs('profile.akun') ?  "text-white bg-wc-red-400" : "bg-white text-wc-red-400" }} hover:text-white hover:bg-wc-red-400">
