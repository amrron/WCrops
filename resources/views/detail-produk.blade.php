    ...
    <nav class="flex mt-6 ms-4 md:ms-0" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                ...
                <a href="/produk?kategori={{ $produk->kategori_id }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{ $produk->kategori->nama_kategori }}</a>
                </div>
            </li>
